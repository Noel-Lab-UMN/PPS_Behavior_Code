function [behav_data, prbs_rising_t] = read_csv_passive_data(meta_folder, MOUSE_NAME)

csv_filename_list = dir(fullfile(meta_folder,sprintf('sync_log_pps_passive_%s*.csv', MOUSE_NAME)));
