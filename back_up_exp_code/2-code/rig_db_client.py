...
class SessionStorageManager:
    ...
    def make_folders(
        ...
        *,
        ...
        nas_dir = self.nas_base_dir / mouse_name / foldername
        nas_dir.mkdir(parents=True, exist_ok=True)

        local_dir = self.local_base_dir / mouse_name / foldername
...
class SessionManager:
    ...
    def get_next_params(self, *, mouse_id: int, experiment_id: int, defaults: dict[str, Any]) -> dict[str, Any]:
        out = dict(defaults)
    ...
    def begin_session(
        ...
        *,
        ...
        local_dir, nas_dir, foldername, _ = self.storage.make_folders(mouse_name, session_num)
