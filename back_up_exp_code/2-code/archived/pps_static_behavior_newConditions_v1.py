...
class TrialConditionSampler:
    def __init__(self, chunk_size = 1500):
        ...
        self.ball_random_walk_std          = BALL_RANDOM_WALK_VEL_STD_RANGE
    ...
    def _append_chunk(self):
        ...
        new_random_walk_std  = sample_mixture_uniform(self.chunk_size, self.ball_random_walk_std,
                                                0, 0)
...
try:
    ...
    while True:
        ...
        scenery_speed_cm_s = float(v_center) if (v_center is not None) else trial_params["ball_speed"]
