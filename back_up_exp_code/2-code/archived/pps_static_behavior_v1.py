...
match RIG_NAME:
    case 'PPS_training_Rig_3':
        ...
        match REWARD_TARGET:
            case 3.0:
                REWARD_DURATION_MS = 16.98
            case 5.0:
                REWARD_DURATION_MS = 28.63

    case 'PPS_training_Rig_2':
        ARDUINO_PORT = 'COM4'
        match REWARD_TARGET:
            case 3.0:
                REWARD_DURATION_MS = 25.41
                ##### outside of range. Need to re-calibrate with longer opening time
            # case 5.0:
    ...
    case 'PPS_training_Rig_1':
        ...
        match REWARD_TARGET:
            case 3.0:
                REWARD_DURATION_MS = 30.0
            ##### outside of range. Need to re-calibrate with longer opening time
            # case 5.0:
            #     REWARD_DURATION_MS = 15.0
...
SPAWN_GAUSS_CENTER_LIST = [-12.0, 12.0]
...
EXP_CONFIG_FILENAME = os.path.join(session_dir, f"exp_config_pps_behav{mouse_name}_{date_str}_{current_time}.json")
